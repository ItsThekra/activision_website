...
function Home_page() {
  return (
    ...
    <div className='relative h-[500px] sm:h-[700px] overflow-hidden'>
      ...
      <div className='absolute text-white'>
        <img src="https://www.activision.com/content/dam/atvi/Crash/crash-touchui/lava/common/crash-team-rumble-logo.png"  className="img-home-header-custom ml-35 hidden sm:block" alt=""/>
  ...
  <div> 
    ...
    <div className='img-custom-mid-section'><img src="https://www.activision.com/content/dam/atvi/activision/atvi-touchui/activision/home/assets/activision-logo-small.svg"alt="" /></div>
    <div className='img-custom-mid-section'><img src="https://www.activision.com/content/dam/atvi/activision/atvi-touchui/activision/home/assets/cod-logo.svg" alt="" /></div>
    <div className='img-custom-mid-section'><img src="https://www.activision.com/content/dam/atvi/activision/atvi-touchui/activision/home/assets/THPS3+4_Logo.svg" alt="" /></div>
    <div className='img-custom-mid-section'><img src="https://www.activision.com/content/dam/atvi/activision/atvi-touchui/activision/home/assets/crash-bandicoot-logo.png" alt="" /></div>
    </div>
  ...
  <div className=' flex gap-5 justify-evenly mt-10 h-590 sm:h-200 flex-wrap'>
    ...
    <div className='bg-neutral-900  flex flex-col items-center text-white h-100 rounded-2xl w-100'>
      <img src="https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/blog/hero/BO6-SEASON-04-NARRATIVE-TOUT.jpg" alt="" className='h-100 W-100 rounded-t-2xl ' />
     ...
     <div className='bg-neutral-900 w-100 flex flex-col items-center text-white h-100 rounded-2xl '>
      <img src="https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/blog/body/code/CODE-MAM-GY6-TOUT.jpg" alt="" className='h-100 W-100 rounded-t-2xl' />
      <div className='pt-8 pb-5 justify-end w-100 p-5'>
      <p>MAY 20, 2025</p>
      <h2>Stitch Returns in Season 04</h2>
      <p className='mt-4'>READ MORE</p>
     ...
     <div className='bg-neutral-900 w-100 flex flex-col items-center text-white h-100 rounded-2xl'>
      <img src="https://www.tonyhawkthegame.com/content/dam/atvi/tony-hawk/blog/chicago/el-rey-blog/THPS-ELREY-IMAGE-TOUT.jpg" alt="" className='h-100 W-100 rounded-t-2xl' />
      <div className='pt-8 pb-5 justify-end w-100 p-5'>
      <p>MAY 20, 2025</p>
      <h2>Stitch Returns in Season 04</h2>
      <p className='mt-4'>READ MORE</p>
     ...
     <div className='bg-neutral-900 w-100 flex flex-col items-center text-white h-100 rounded-2xl'>
      <img src="https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/blog/body/ricochet/bo6-season-03-ricochet/COD-BO6-RICOCHET-S03R-TOUT-A.webp" alt="" className='h-100 W-100 rounded-t-2xl ' />
      <div className='pt-8 pb-5 justify-end w-100 p-5'>
      <p>MAY 20, 2025</p>
      <h2>Stitch Returns in Season 04</h2>
      <p className='mt-4'>READ MORE</p>
     ...
     <div className='bg-neutral-900 w-100 flex flex-col items-center text-white h-100 rounded-2xl'>
      <img src="https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/blog/body/code/CODE-MAM-2025-IMAGE-TOUT.webp" alt="" className='h-100 W-100 rounded-t-2xl ' />
      <div className='pt-8 pb-5 justify-end w-100 p-5'>
      <p>MAY 20, 2025</p>
      <h2>Stitch Returns in Season 04</h2>
      <p className='mt-4'>READ MORE</p>
     ...
     <div className='bg-neutral-900 w-100 flex flex-col items-center text-white h-100 rounded-2xl'>
      <img src="https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/blog/hero/bo6/BO6-S03R-ANNOUNCEMENT-TOUT.webp" alt="" className='h-100 W-100 rounded-t-2xl' />
      <div className='pt-8 pb-5 justify-end w-100 p-5'>
      <p>MAY 20, 2025</p>
      <h2>Stitch Returns in Season 04</h2>
      <p className='mt-4'>READ MORE</p>
